...
export function makeTimestampView(date: Date): TimestampView {
	const result = {
		get dateTime() { return `<t:${this.unixSecs}:f>`; },
		get dateTimeLong() { return `<t:${this.unixSecs}:F>`; },
		get time() { return `<t:${this.unixSecs}:t>`; },
		get timeLong() { return `<t:${this.unixSecs}:T>`; },
		get date() { return `<t:${this.unixSecs}:d>`; },
		get dateLong() { return `<t:${this.unixSecs}:D>`; },
		get relative() { return `<t:${this.unixSecs}:r>`; },
		get unix() { return date.getTime(); },
		get unixSecs() { return dateToUnixSecs(date); },

		toString() { return this.dateTime; }
	};
