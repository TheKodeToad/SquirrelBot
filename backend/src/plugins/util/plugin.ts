...
import inviteInfo from "#plugins/util/commands/inviteInfo/inviteInfo.ts";
import ping from "#plugins/util/commands/ping.ts";
import snowflake from "#plugins/util/commands/snowflake.ts";
