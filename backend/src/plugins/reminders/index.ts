...
import remind from "#plugins/reminders/command/remind.ts";
import reminderCancel from "#plugins/reminders/command/reminderCancel.ts";
import reminderList from "#plugins/reminders/command/reminderList.ts";
