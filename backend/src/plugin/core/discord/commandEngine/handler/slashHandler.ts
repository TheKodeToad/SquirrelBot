...
import { readSlashArgs } from "#plugin/core/discord/commandEngine/parsing/slashParser.ts";
import { transformReply } from "#plugin/core/discord/helper/commands.ts";
import { coreConfigStore } from "#plugin/core/index.ts";
import { type Command, type CommandContext, OptionType, type Reply } from "#plugin/core/public/discord/command.ts";
