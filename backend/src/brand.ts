...
export const APP_LIBRARIES_LINK = "https://github.com/TheKodeToad/SquirrelBot/blob/develop/backend/package.json";
export const APP_INVITE_PERMISSIONS = Permissions.VIEW_AUDIT_LOG | Permissions.KICK_MEMBERS | Permissions.BAN_MEMBERS
