...
import { component_interaction_handler } from "./command_engine/handler/component_handler.ts";
import { prefix_delete_handler, prefix_edit_handler, prefix_send_handler } from "./command_engine/handler/prefix_handler.ts";
import { slash_run_handler, sync_slash_commands } from "./command_engine/handler/slash_handler.ts";
