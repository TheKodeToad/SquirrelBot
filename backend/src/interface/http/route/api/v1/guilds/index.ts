...
import { guildAuthMiddleware } from "#interface/http/middleware/guildAuth.ts";
import config from "#interface/http/route/api/v1/guilds/config.ts";
import moderation from "#interface/http/route/api/v1/guilds/moderation/index.ts";
