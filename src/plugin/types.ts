...
export const EVENT_TO_GUILD = define_event_mapping({
	...
	guildMemberChunk: members => members.length !== 0 ? members[0].guildID : null,
	...
	messageDeleteBulk: messages => messages.length !== 0 ? messages[0].guildID ?? null : null,
	...
	threadListSync: threads => threads.length !== 0 ? threads[0].guildID : null,
